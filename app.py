...
def login():
    ...
    if request.method == "POST":
        ...
        # Default admin login check (તમારી જરૂરિયાત મુજબ)
    ...
    return render_template_string('''
        ...
        <body>
            ...
            function startVoiceRecognition() {
                ...
                recognition.onstart = () => { document.getElementById("voiceStatus").innerText = "સંભળાઈ રહ્યું છે... બોલો!"; };
                recognition.onresult = (event) => {
                    const spokenText = event.results[0][0].transcript;
                    document.getElementById("voiceStatus").innerText = "તમે બોલ્યા: " + spokenText;
                    sendQueryToAI(spokenText);
                };
                recognition.onerror = () => { document.getElementById("voiceStatus").innerText = "કંઈક ભૂલ થઈ, ફરી પ્રયત્ન કરો."; };
                recognition.start();
            }
